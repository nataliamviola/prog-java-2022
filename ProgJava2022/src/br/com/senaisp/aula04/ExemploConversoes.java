...
public class ExemploConversoes {
	...
	public static void main(String[] args) {
		...
		System.out.println("Vamos iniciar a conversão de String em Números");
		String strValor = "52";
		//Convertendo para Double
		...
		System.out.println("Byte:" + bytTeste);
		//Convertendo Num para String
		System.out.println("Agpra vamos converter números para String/Caracteres");
		...
		System.out.println("Double para Strinh:" + strTeste);
