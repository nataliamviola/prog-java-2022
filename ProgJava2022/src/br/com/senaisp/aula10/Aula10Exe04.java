...
public class Aula10Exe04 {
	...
	public static void main(String[] args) {
		...
		while (intResp != 2) {
			...
			//dando entrada na temperatura origem criada com função
	 ...
	 */
	public static int entradaTemperatura (Scanner sc, String strMsg) { //se tiver um tipo em public static (ex: int) designa como função (void não é tipo)
		int intTempOri;
		do {
			System.out.println(strMsg);
			intTempOri = sc.nextInt();
		} while (intTempOri != 1 && intTempOri != 2 && intTempOri != 3);
		return intTempOri; //toda função exige um retorno
	}
